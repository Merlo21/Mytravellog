...
import { useSettings, DistanceUnit, TemperatureUnit, GlobeStyle, GlobeLabels, AutoRotate, Theme } from "@/lib/settings";
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8 max-w-xl">
        ...
        <Group
          icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10"/></svg>}
          title="Stile del globo"
          desc="Aspetto visivo della mappa 3D"
        >
        ...
        <Group
          ...
          title="Città sul globo"
          desc="Quali città mostrare quando zoomi"
        >
          <SegmentControl<GlobeLabels>
            value={s.globeLabels} onChange={s.setGlobeLabels}
            options={[
              { value: "none",     label: "Nessuna" },
              { value: "capitals", label: "Capitali" },
              { value: "major",    label: "Principali" },
