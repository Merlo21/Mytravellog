...
import { Plus, Loader2, MapPin, X, Plane, Train, Car, Ship, Footprints, Route, Search } from "lucide-react";
      ...
      <div>
        <div style={{ position:"relative", paddingBottom:8 }}>
          ...
          <div style={{ position:"absolute", top:50, left:35, width:40, height:40,
            ...
            fontSize:18, cursor:"pointer" }} onClick={onEditHome}>
            🏠
          </div>
        </div>
        {editingHome && (
    ...
    <div style={{ position:"relative" }}>
        ...
        {stops.map((stop, i) => {
          ...
          return (
            <g key={i}>
              ...
              <text x={mx} y={cy-arcH-2} fontSize="9.5" textAnchor="middle" fill={t.color}>{t.label}</text>
            </g>
          );
        })}
        {stops.map((stop, i) => {
      ...
      <div style={{ position:"absolute", top:0, left:0, width:"100%", pointerEvents:"none" }}>
        {stops.map((stop, i) => {
          ...
          return (
            <div key={i} style={{
              position:"absolute", left:x-12, top:cy-12,
              width:24, height:24, display:"flex", alignItems:"center",
              justifyContent:"center", fontSize:isLast ? 17 : 15,
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"14px 20px",
          ...
          <div>
            ...
            <input style={{ background:"#060e1e", border:"0.5px solid #1a2d4a", borderRadius:8,
              padding:"8px 11px", fontSize:12, color:"#f0f4ff", width:"100%",
          ...
          <div>
            ...
            <div style={{ background:"#060e1e", border:"0.5px solid #1a2d4a",
              borderRadius:8, padding:"16px 14px 12px", overflowX:"auto" }}>
          ...
          <div style={{ display:"flex", gap:10, alignItems:"flex-start" }}>
            <div style={{ flex:1 }}>
              ...
              <textarea style={{ background:"#060e1e", border:"0.5px solid #1a2d4a", borderRadius:8,
                padding:"8px 11px", fontSize:12, color:"rgba(255,255,255,0.4)", width:"100%",
