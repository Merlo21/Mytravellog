  ...
  return (
    <div className="space-y-6 animate-fade-up">
      <div style={{position:"relative",width:"100%",display:"flex",justifyContent:"center",alignItems:"center",minHeight:420}}>
        ...
        ].map(({ label, value, sub, color, bg, Icon, angle }) => {
          const rad = (angle * Math.PI) / 180;
          const px = 250 + 140 * Math.cos(rad);
          const py = 210 + 140 * Math.sin(rad);
          return (
            <div key={label} style={{position:"absolute",left:"calc(50% + "+(px-250)+"px)",top:py,transform:"translate(-50%,-50%)",width:120,background:"#0a1628",border:"0.5px solid "+color,borderRadius:12,padding:"10px 12px",display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center",gap:4}}>
