...
export function EditTripDialog({ trip, open, onOpenChange, onSaved }: Props) {
  ...
  return createPortal(<div style={{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,14,30,0.55)",backdropFilter:"blur(16px)"}}
