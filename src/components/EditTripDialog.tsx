    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              ...
              <Input id="edit-temp" type="number" step="0.1" value={temp} onChange={(e) => setTemp(e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="edit-alt">Altitudine (m)</Label>
              <Input id="edit-alt" type="number" step="1" value={alt} onChange={(e) => setAlt(e.target.value)} />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="edit-dist">Km da casa</Label>
              <Input id="edit-dist" type="number" step="1" value={dist} onChange={(e) => setDist(e.target.value)} />
            </div>
          </div>
        </div>
        ...
        <DialogFooter className="gap-2">
          ...
          <Button variant="hero" onClick={save}>Salva modifiche</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
